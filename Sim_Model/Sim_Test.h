...
public://模型导向自动生成变量
	...
	//被测模型申明
	Sns_Model_OSPFv2 *Sns_model_testObj; //当前测试的模型
...
/////////////////////////////////被测模型出消息处理函数/////////////////////////////////////////
	//功能：MSG_OutEVENT_OSPFv2_toNetworkIP事件函数 
	void  Process_MSG_OutEVENT_OSPFv2_toNetworkIP(Sns_Message *msg); 
